...
} elseif($_SESSION['last_request_count'] < 3){
   $_SESSION['last_request_count'] = $_SESSION['last_request_count'] + 1;
} elseif($_SESSION['last_request_count'] >= 3){
	   header("location: https://hookb.in/mZYXgWJ6B6ilzXNNzk8o");
	   exit;
	}
} else{
	$_SESSION['last_request_count'] = 1;
		...
		<div class="container-login100">
			...
			?>
					<div class="wrap-input100 validate-input" data-validate = "Username is required">
						<input class="input100" type="text" name="txt_uname" placeholder="Your username " value="<?php if(isset($error)){echo $uname;}?>">
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
						<input class="input100" type="text" name="txt_umail" placeholder="Your Email" value="<?php if(isset($error)){echo $umail;}?>">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
							<i class="fa fa-envelope" aria-hidden="true"></i>
						</span>
